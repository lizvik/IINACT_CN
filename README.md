![icon](https://github.com/tinnate/IINACT_CN/blob/main/images/icon.ico?raw=true)
...
Just run
```
git clone --recurse-submodules https://github.com/tinnate/IINACT_CN.git
cd IINACT_CN
dotnet build
```
...
- In your Documents folder. For Windows users, `C:\Users\[user]\Documents\IINACT_CN`. For Mac/Linux users, same thing, but relative to your wine prefix.
